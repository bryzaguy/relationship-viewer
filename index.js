...
function restart() {
  ...
  path.classed(style.selected, function(d) { return d === selected_link; })
  ...
  path.enter().append('svg:path')
    ...
    .classed(style.selected, function(d) { return d === selected_link; })
    .style('marker-start', function(d) { return d.left ? 'url(#start-arrow)' : ''; })
    .style('marker-end', function(d) { return d.right ? 'url(#end-arrow)' : ''; })
  ...
  g.append('svg:text')
      ...
      .attr('font-size', function(d) { return '33';} )
...
var Test = React.createClass({
	render() {
		return <div>Relationship Viewer</div>;
	}
});
